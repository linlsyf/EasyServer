...
public class TestImage {
    ...
    //easy.alipay.mobile.public.multimedia.upload
    //easy.alipay.mobile.public.multimedia.download
    private static String apiMethodName       = "easy.alipay.mobile.public.multimedia.download";
    ...
    //公用变量
    public static String  serverUrl           = "https://openfile.easy.alipay.com/chat/multimedia.do";
